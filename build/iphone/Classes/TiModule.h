...
/**
 The base class for all VFW_Project4_1409 modules
 */
...
/**
 VFW_Project4_1409 Platform calls this method on startup.
 */
-(void)startup;

/**
 VFW_Project4_1409 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 VFW_Project4_1409 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 VFW_Project4_1409 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 VFW_Project4_1409 Platform calls this method on resume.
 @param sender The sender of the event.
 */
