...
/**
 Base class for all VFW_Project4_1409 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the VFW_Project4_1409 view hierarchy (such as wrapped iOS UIViews) was touched.
