...
@interface VFW_Project4_1409Object : KrollCoverageObject {
#else
@interface VFW_Project4_1409Object : KrollObject {
#endif
@private
...
extern NSString * VFW_Project4_1409$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	VFW_Project4_1409Object *_vfw_project4_1409;
    KrollObject* console;
	BOOL shutdown;
