 ...
 * to send analytic data that can be viewed on the VFW_Project4_1409 Dashboard.
 *
 * For information on getting started with VFW_Project4_1409 Platform Services,
