...
// in simulator we redefine to format for VFW_Project4_1409 Developer console
...
{\
	NSString * exceptionName = [@"org.vfw_project4_1409." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vfw_project4_1409";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVFW_Project4_1409NativeItemNone = -1, 
	UIVFW_Project4_1409NativeItemSpinner = -2,
	UIVFW_Project4_1409NativeItemProgressBar = -3,
	
	UIVFW_Project4_1409NativeItemSlider = -4,
	UIVFW_Project4_1409NativeItemSwitch = -5,
	UIVFW_Project4_1409NativeItemMultiButton = -6,
	UIVFW_Project4_1409NativeItemSegmented = -7,
	
	UIVFW_Project4_1409NativeItemTextView = -8,
	UIVFW_Project4_1409NativeItemTextField = -9,
	UIVFW_Project4_1409NativeItemSearchBar = -10,
	
	UIVFW_Project4_1409NativeItemPicker = -11,
	UIVFW_Project4_1409NativeItemDatePicker = -12,
	
	UIVFW_Project4_1409NativeItemInfoLight = -13,
	UIVFW_Project4_1409NativeItemInfoDark = -14,
	
	UIVFW_Project4_1409NativeItemDisclosure = -15,
	
	UIVFW_Project4_1409NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VFW_Project4_1409 instances of
